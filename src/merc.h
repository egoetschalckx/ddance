...
#define SKILL_DIR		"../player/skill/"		/*Skill Files*/
...
#define TEMP_FILE		"../player/romtmp"
#define NULL_FILE		"../area/nul"		/* To reserve one stream        */
...
#define STAT_FILE       "../area/statlist.lst" /*Enzo 6/20/2002*/

//#define EXE_DEBUG		"../Debug/Rom24.exe" /* debugging copyover file */
